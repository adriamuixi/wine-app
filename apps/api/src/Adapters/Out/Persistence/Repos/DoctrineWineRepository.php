...
SQL,
        ...
        foreach ($rows as $row) {
            ...
            $items[] = new WineListItemView(
                ...
                agingType: !array_key_exists('aging_type', $row) || null === $row['aging_type'] ? null : (string) $row['aging_type'],
    ...
    private function toReviewBullet(string $value): ReviewBullet
    {
        return match ($value) {
            ...
            // Legacy values now mapped to the closest supported bullets.
            'spicy' => ReviewBullet::Potente,
            'easy_drinking' => ReviewBullet::Afrutado,
            'elegant' => ReviewBullet::Floral,
            'food_friendly' => ReviewBullet::Mineral,
            'especiado' => ReviewBullet::Potente,
            'facil_de_beber' => ReviewBullet::Afrutado,
            'elegante' => ReviewBullet::Floral,
            'gastronomico' => ReviewBullet::Mineral,
