...
final class DoPhotoController
{
    public function __construct(private readonly CreateDoAssetHandler $createDoAssetHandler)
    {
    }
    ...
    public function create(int $id, Request $request): JsonResponse
    {
        ...
        } catch (CreateDoAssetValidationException $exception) {
            return new JsonResponse(['error' => $exception->getMessage()], Response::HTTP_BAD_REQUEST);
        } catch (CreateDoAssetNotFound $exception) {
