    ...
    private function buildCreateCommand(int $authenticatedUserId, int $wineId, array $payload): CreateReviewCommand
    {
        try {
            return new CreateReviewCommand(
                ...
                wineId: $wineId,
                aroma: $this->parseRequiredInt($payload['aroma'] ?? null, 'aroma'),
                appearance: $this->parseRequiredInt($payload['appearance'] ?? null, 'appearance'),
                palateEntry: $this->parseRequiredInt($payload['palate_entry'] ?? null, 'palate_entry'),
